...
- [ ] T001 [US1] Create `src/tools/update-ticket.ts` with tool factory function signature
...
- [ ] T002 [US1] Implement input validation in execute function
...
- [ ] T003 [US1] Implement provider resolution using detectTicketRef
...
- [ ] T004 [US1] Implement label calculation logic
...
- [ ] T005 [US1] Implement core update logic calling provider.updateTicket()
...
- [ ] T006 [US1] Implement state change handling
...
- [ ] T007 [US1] Implement error handling for NotFoundError
...
- [ ] T008 [US1] Implement terse output response format
...
- [ ] T009 [US1] Export createUpdateTicketTool from `src/tools/index.ts`
...
- [ ] T010 [P] [US1] Create test file `tests/update-ticket-tool.test.ts`
