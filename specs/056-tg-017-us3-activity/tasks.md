...
- [X] T001 [US3] Create `ActivityFeedPanel` class extending `WebviewBase` in `packages/agency-extension/src/views/activity/ActivityFeedPanel.ts`
...
- [X] T002 [US3] Define message type interfaces in `ActivityFeedPanel.ts`
...
- [X] T003 [US3] Implement `getHtmlContent()` method with base HTML structure
...
- [X] T004 [P] [US3] Implement statistics summary section in HTML/JS
  - Total calls counter
...
- [X] T005 [P] [US3] Implement filter controls in HTML/JS
...
- [X] T006 [US3] Implement filter change handling
...
- [X] T007 [US3] Implement virtual scrolling for event list
...
- [X] T008 [US3] Implement event row rendering
...
- [X] T009 [US3] Implement real-time event updates
...
- [X] T010 [US3] Implement expandable event details
  - Click handler to toggle expansion
  - Smooth expand/collapse animation
  - Track expanded state per event ID

- [X] T011 [US3] Implement detail content rendering
...
- [X] T012 [US3] Implement JSON syntax highlighting utility
...
- [X] T016 [US3] Export `ActivityFeedPanel` from `packages/agency-extension/src/views/index.ts`

- [X] T017 [US3] Add webview-specific CSS styles
...
- [X] T018 [US3] Implement state persistence
...
- [X] T019 [P] [US3] Create unit tests for ActivityFeedPanel in `packages/agency-extension/src/__tests__/views/ActivityFeedPanel.test.ts`
...
- [X] T020 [P] [US3] Add filter logic tests
