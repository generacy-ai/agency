...
- [ ] T001 Create devcontainer detection utility in `packages/agency-extension/src/utils/devcontainerDetector.ts`
- [ ] T002 Create McpConnectionManager service in `packages/agency-extension/src/services/McpConnectionManager.ts`
- [ ] T003 Fix ContainerTreeProvider event subscription (change `onDidChangeState` to `onContainerStateChange`) in `packages/agency-extension/src/providers/ContainerTreeProvider.ts`
...
- [ ] T004 [US1] Implement `startContainer` command in `packages/agency-extension/src/commands/containerCommands.ts`
- [ ] T005 [US1] Add devcontainer.json validation before start in `packages/agency-extension/src/commands/containerCommands.ts`
- [ ] T006 [US1] Add progress notification for start operation in `packages/agency-extension/src/commands/containerCommands.ts`
- [ ] T007 [US1] Register startContainer command in `packages/agency-extension/src/extension.ts`
...
- [ ] T008 [US2] Implement `stopContainer` command in `packages/agency-extension/src/commands/containerCommands.ts`
- [ ] T009 [US2] Add MCP disconnect coordination via McpConnectionManager in `packages/agency-extension/src/services/McpConnectionManager.ts`
- [ ] T010 [US2] Register stopContainer command in `packages/agency-extension/src/extension.ts`
...
- [ ] T011 [US3] Implement `viewContainerLogs` command in `packages/agency-extension/src/commands/containerCommands.ts`
- [ ] T012 [US3] Add log level filter UI (stdout/stderr dropdown) to webview in `packages/agency-extension/src/views/containers/ContainerDetailPanel.ts`
- [ ] T013 [US3] Implement combined text + log level filtering logic in `packages/agency-extension/src/views/containers/ContainerDetailPanel.ts`
- [ ] T014 [US3] Register viewContainerLogs command in `packages/agency-extension/src/extension.ts`
...
- [ ] T015 Implement `rebuildContainer` command in `packages/agency-extension/src/commands/containerCommands.ts`
- [ ] T016 Add rebuild progress notification with build output in `packages/agency-extension/src/commands/containerCommands.ts`
- [ ] T017 Add MCP reconnect coordination after rebuild via McpConnectionManager in `packages/agency-extension/src/services/McpConnectionManager.ts`
- [ ] T018 Register rebuildContainer command in `packages/agency-extension/src/extension.ts`
...
- [ ] T019 Create command exports in `packages/agency-extension/src/commands/index.ts`
- [ ] T020 Add container picker for commands invoked without tree item context in `packages/agency-extension/src/commands/containerCommands.ts`
- [ ] T021 Add command availability based on container status (enablement) in `packages/agency-extension/package.json`
- [ ] T022 Update context menu for container tree items in `packages/agency-extension/package.json`
- [ ] T023 Initialize McpConnectionManager in extension activation in `packages/agency-extension/src/extension.ts`
