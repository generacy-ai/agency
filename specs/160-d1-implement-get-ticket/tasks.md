...
- [X] T001 Create reference auto-detection utility (`src/utils/detect-ticket-ref.ts`)
...
- [X] T002 [P] Create provider registry (`src/providers/registry.ts`)
...
- [X] T003 Implement GitHub provider (`src/providers/github.ts`)
...
- [X] T004 [P] Create stub providers for Jira, Shortcut, Local (`src/providers/jira.ts`, `src/providers/shortcut.ts`, `src/providers/local.ts`)
...
- [X] T005 Create get_ticket tool (`src/tools/get-ticket.ts`)
...
- [X] T006 Register tool in tools index (`src/tools/index.ts`)
  - Import `createGetTicketTool` from `get-ticket.ts`
  - Add to tool registration list
  - Export from module

- [X] T007 [P] Update providers index exports (`src/providers/index.ts`)
...
- [X] T008 Add unit tests for detect-ticket-ref utility
...
- [X] T009 [P] Add unit tests for GitHub provider
...
- [X] T010 [P] Add integration test for get_ticket tool
