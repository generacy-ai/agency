...
- **Playwright** - Browser automation for testing web components
- **Additional servers** - Consider what's useful for this repo's domain (e.g., Firebase for backend repos)

## Acceptance Criteria

- [ ] `CLAUDE.md` exists and documents the repo accurately
- [ ] `.specify/templates/` contains all 5 template files
- [ ] `.mcp.json` configures at least Context7 and any domain-relevant MCP servers
